      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-3">
        {pipeline.map(
          ({
            ...
            <article
              key={id}
              className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all p-3 text-xs"
            >
              {/* Header */}
              <div className="flex justify-between items-center mb-2">
                <span className="px-2 py-1 rounded-full bg-pink-100 text-pink-600 capitalize text-[10px]">
                  {stale}
                </span>
